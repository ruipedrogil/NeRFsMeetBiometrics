# Import required libraries for system operations, data processing, and visualization
import os
import subprocess
import json
import argparse
...
# Main function to evaluate similarity matrix
def main(args):
    ...
    # Nested loop through all combinations of model and test subjects
    for model_person in PEOPLE:
        ...
        for test_person in PEOPLE:
            ...
            # Prepare command to run face recognition
            ...
            # Process JSON output from face recognition
    ...
    # Generate bar plots for each model's results
    ...
    # Generate similarity heatmap for all models and tests
